...
Moon = Object(name="Moon", position=(130.0, 150.0), radius=1.737, mass = 7.347e22)
Craft = Object(name="SpaceCraft", position=(45.0, 93.0), radius=1, mass=1.0e4)
#Jupiter = Object(name="Jupiter", position=(200.0, 100,0), radius=10, mass=1.0e26)

Craft.giveMotion(deltaV=9300.0, motionDirection=125, time=160000)
